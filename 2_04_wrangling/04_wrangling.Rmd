...
In class, we will practice wrangling our data, getting comfortable with rearranging it such that we can do this later before plotting. Click [here]() for the recitation materials.
