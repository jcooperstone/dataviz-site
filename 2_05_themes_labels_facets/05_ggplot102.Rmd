...
We will will build upon our last lesson on [ggplot101](https://datavisualizing.netlify.app/2_04_ggplot/04_ggplot) which focused on an overall understanding of the grammar of graphics, basic syntax, adding data, aesthetic mappings, and geoms. Today we will focus on some of the other more commonly adjusted layers:
...
In class, we will practice using ggplot and adjusting facets, scales, labels, and themes. Click [here](05_ggplot102_recitation.html) for the recitation materials.
