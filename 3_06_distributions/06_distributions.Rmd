...
alkaloids %>%
  ...
  labs(x = "Alpha-tomatine content, mg/100g fresh weight",
       y = "",
...
I am bothered by the fact that S. pimpinellifolium (a species of wild tomato) is not indicated in italics. We don't want to italicize all of the `Class labels`, just *S. pimpinellifolium*. Let's fix that.
...
alkaloids %>%
  ...
  scale_x_continuous(trans = "log10", labels = comma) + 
  scale_y_discrete(labels = class_labels) +
  labs(x = "Alpha-tomatine, mg/100 g fresh weight",
       y = "",
...
In class, we will practice using ggplot and investigating data distributions.

You can find the in class content [here](3_06_distributions/06_distributions_recitation.html).
