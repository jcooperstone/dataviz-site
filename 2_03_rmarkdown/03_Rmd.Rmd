...
Think about how you could use this -- embed information from your data analysis (e.g, p-values) within your narrative text.
...
knitr::include_graphics("img/visual_editor_screenshot.png")
```
