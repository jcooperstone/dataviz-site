---
title: "Interactive plots with ggplotly"
...
Plotly is one the most popular library to create interactive plots for its 
extensive maintenance, documentation, and most important, it looks beautiful.
However, the top 1 reason is how easy to use is with the adaptation of ggplot2.
...
Now, we are going to explore multiple examples of the integration between
ggplot2 and plotly with the parsing function 
...
Toltip is an argument that controls the text that is shown when you hover 
the mouse over the data. By default, all mapping variables are shown. You can 
