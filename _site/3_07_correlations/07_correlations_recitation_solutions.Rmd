...
NHANES_dia_cor <- cor(NHANES_diastolic)

# could also use rcorr()
NHANES_dia_rcorr <- rcorr(as.matrix(NHANES_diastolic))
```
...
```{r ggpairs q2, fig.height = 6, fig.width = 6}
nhanes_trimmed %>%
    ggpairs(columns = 1:5,
          aes(alpha = 0.01), # note alpha inside aes which is weird idk why
