...
```{r xkcd null hypothesis, fig.cap= "Figure from [XKCD](https://www.explainxkcd.com/wiki/index.php/1478:_P-Values)", out.width = "30%", fig.align = "center", echo = FALSE}
...
```{r palmer penguins hex, out.width = "20%", fig.align = "center", echo = FALSE}
...
```{r normal distribution, fig.alt = "An orange normal distribution and a blue bimodal distribution, where the orange distribution tells the blue one it is not normal", fig.cap = "Illustration by [Allison Horst](https://github.com/allisonhorst/stats-illustrations)", out.width = "70%", fig.align = "center", echo = FALSE}
...
In class, we will practice adding statistical analysis to our plots.

You can find the in class content [here](3_08_add_stats/08_add_stats_recitation.html).
