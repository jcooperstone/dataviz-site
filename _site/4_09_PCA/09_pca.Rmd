...
We are going to go over making scree, scores and loadings plots using helper functions, and manually via ggplot. The helper functions  allow you look at each plot type simply. This is an important step because when you make your plots with ggplot, you want to be sure they look how they should.
...
You can actually do this very easily with base R plotting as well. If you weren't planning to publish this type of plot, it might not be important it look beautiful, and then both of these options would be great and quick.
...
importance_tidy %>%
  ...
  labs(x = "Principal component",
       ...
       title = "Scree plot of 10 alkalois analyzed across 107 tomato accessions")
...
In class, we will practice adding running PCA and making scree, scores, and loadings plots. 
