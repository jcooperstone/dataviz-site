...
RMarkdown provides a framework for saving and executing code, and sharing your results.

Here is a 1.2 min on the high level of what R Markdown is, and how it can be used.

![A video about R Markdown](https://vimeo.com/178485416)
...
R Markdown files have the file format `.Rmd`.
...
knitr::include_graphics("reproducibility_court.png")
```
...
knitr::include_graphics("trying_rmarkdown.png")
```

### Saving our file

We gave our file a title, but if you look at the top right corner of our new document, you'll see it's called "Untitled1". Let's change the name to something easier for our future selves to recognize.

```{r saving_rmarkdown, fig.alt = "A screenshot of a new, default R Markdown document.", fig.align = "center", echo = FALSE}
knitr::include_graphics("saving_rmarkdown.png")
```
...
knitr::include_graphics("knit_screenshot.png")
```
...
knitr::include_graphics("template_rmarkdown.png")
```
...
-   title: "Your title put put it in quotes"
-   author: "The author and still in quotes"
-   date: the date you want at the top of your doc in quotes. If you want this to be today's date (whatever that is) you can use "`r Sys.Date()`"
...
These are just some of the options that I like to put in my YAML, but there are tons more. Additional output options that are explained on the second page of the [RStudio R Markdown cheatsheet](https://raw.githubusercontent.com/rstudio/cheatsheets/main/rmarkdown.pdf).

## Text

Unlike an R script, where R by default interprets anything as code (and material that isn't code needed to be commented out by using \#), in an R Markdown, the default is text (and code exists only within code chunks or backticks).
...
You can use Markdown to insert tables, images, mathematical formulas, block quotes, and almost anything else you'd like. You can even write your [papers and dissertation](https://bookdown.org/) in R Markdown. This [course website](https://rstudio.github.io/distill/) is made with R Markdown. My [lab website](www.cooperstonelab.com) is made with [R Markdown and the hugo Aperó theme](https://hugo-apero-docs.netlify.app/). Here are some links where you can find lots of other Markdown syntactical information:
...
knitr::include_graphics("chunk_screenshot.png")
```
...
```{r in chunk annotation, eval = FALSE}
# here is my in chunk annotation
some_function()
```

When you knit your R Markdown, this process will run all of the code in your document. This means if you have code that throw errors or don't work, your document **will not knit**.
...
```{r table of contents, fig.alt = "A screenshot of the button to access the table of contents, allowing you to navigate between different parts of your R Markdown document.", fig.align = "center", echo = FALSE}
knitr::include_graphics("toc_screenshot.png")
```
...
knitr::include_graphics("naming_chunks.png")
```
...
knitr::include_graphics("visual_editor_screenshot.png")
```
...
In class, we will practice using R Markdown.
