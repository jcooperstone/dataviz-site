...
You can use Markdown to insert tables, images, mathematical formulas, block quotes, and almost anything else you'd like. You can even write your [papers and dissertation](https://bookdown.org/) in R Markdown. This [course website](https://datavisualizing.netlify.app/) is made with [distill](https://rstudio.github.io/distill/) and R Markdown. My [lab website](www.cooperstonelab.com) is made with [R Markdown and the hugo Aperó theme](https://hugo-apero-docs.netlify.app/). Here are some links where you can find lots of other Markdown syntactical information:
